...
{
    public class HistoryOriginalOrder
    {
        ...
        public virtual HistoryOriginalOrderBatch HistoryOriginalOrderBatch { get; private set; }
        public virtual ICollection<HistoryOriginalOrderDetail> OriginalOrderDetails { get; private set; } = new List<HistoryOriginalOrderDetail>();
    }
}
